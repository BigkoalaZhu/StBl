...
#include "ThreadsGraphCurve.h"
#include "ThreadsGraphSheet.h"
...
namespace ThreadsGraph{
	...
	struct Graph
	{
		...
		QVector<ThreadsGraph::Node*> nodesWithProperty(QString propertyName);
		QVector<ThreadsGraph::Node*> nodesWithProperty(QString propertyName, QVariant value);

		QVector<ThreadsGraph::Node*> path(ThreadsGraph::Node * from, ThreadsGraph::Node * to);
...
Q_DECLARE_METATYPE(ThreadsGraph::Graph *)
Q_DECLARE_METATYPE(ThreadsGraph::NodeGroups)
