...
namespace ThreadsGraph{
	...
	{
		// Constructors
		Sheet(const NURBS::NURBSRectangled & sheet, QString sheetID, QColor color = starlab::qRandomColor2());
		Node * clone();
		...
		void equalizeControlPoints(ThreadsGraph::Node * other);
