...
public:
    ...
    BSplineBasis (size_t numCtrlPoints, int degree, bool open);
    void Create (size_t numCtrlPoints, int degree, bool open);
    ...
    BSplineBasis (size_t numCtrlPoints, int degree, const Real* interiorKnot);
    void Create (size_t numCtrlPoints, int degree, const Real* interiorKnot);
