...
//----------------------------------------------------------------------------
template <typename Real>
BSplineBasis<Real>::BSplineBasis (size_t numCtrlPoints, int degree, bool open)
{
    Create(numCtrlPoints, degree, open);
}
//----------------------------------------------------------------------------
template <typename Real>
void BSplineBasis<Real>::Create (size_t numCtrlPoints, int degree, bool open)
{
    mUniform = true;
...
//----------------------------------------------------------------------------
template <typename Real>
BSplineBasis<Real>::BSplineBasis (size_t numCtrlPoints, int degree,
...
//----------------------------------------------------------------------------
template <typename Real>
void BSplineBasis<Real>::Create (size_t numCtrlPoints, int degree,
    const Real* interiorKnot)
{
    mUniform = false;
